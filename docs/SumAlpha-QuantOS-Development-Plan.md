...
- issues:
  ...
  - issue_id: F06-A10
    ...
    evidence: docs/audit/F06-A10-status-governance-2026-09-25.md
    status: OPEN
- fix_tracking:
  - issue_id: F06-A03
