...
> 历史记录：本报告记录 2026-09-21 首次远端执行被账户付款/Actions spending limit 阻止的状态。阻断解除后的同 SHA 语义重跑已在完整提交 `6b06a90de275fb38f5efb7982fd2e09dd5963581` 上全部通过，最终结论见 [`F05-remote-acceptance-6b06a90-2026-09-21.md`](./F05-remote-acceptance-6b06a90-2026-09-21.md)。
