...
| 对照现有 Proto/API client | 达成 | 6 个 Proto 文件、38 messages、15 enums、2 services、7 RPC、48 JSON Schemas；BFF OpenAPI 1.3.0 有 62 operations/51 schemas，generated manifest 精确一致 |
