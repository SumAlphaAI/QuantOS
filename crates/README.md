...
- `quantos-execution`: short-lived, signed, idempotent `TradeCommand` issuance with approval verification, self-approval bans, and deterministic rejection classes.
