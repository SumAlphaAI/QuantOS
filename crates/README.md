...
- `quantos-strategy`: versioned strategy drafts and parameter models, optimistic-concurrency conflict detection, approved snapshot/artifact reference gating, and validation handoff rules.
