...
pub mod engine_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("quantos.engine.v1.EngineService", "GetMetadata"),
                );
        ...
        pub async fn health(
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("quantos.engine.v1.EngineService", "Health"));
            self.inner.unary(req, path, codec).await
        }
        ///
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("quantos.engine.v1.EngineService", "Execute"));
            self.inner.unary(req, path, codec).await
        }
        ///
        pub async fn stream_execute(
            &mut self,
            request: impl tonic::IntoRequest<super::StreamExecuteRequest>,
        ) -> std::result::Result<
            tonic::Response<tonic::codec::Streaming<super::StreamExecuteResponse>>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("quantos.engine.v1.EngineService", "StreamExecute"),
                );
        ...
        pub async fn cancel(
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("quantos.engine.v1.EngineService", "Cancel"));
            self.inner.unary(req, path, codec).await
        }
    }
}
